    ...
    <>
      <section className='max-w-6xl mx-auto flex justify-center items-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form>
            {/* Name Input */}
           <input type="text" id="name" value={name} onChange={onChange} disabled={!changeDetail} 
           ...
           <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6'>
            ...
            <p onClick={onLogOut} className='text-blue-600 hover:text-blue-800 transition duration-200 ease0in-out cursor-pointer'>Sign out</p>
           </div>
          </form>
